...
PARAM$semilla  <- 211007      #Establezco la semilla aleatoria, cambiar por SU primer semilla
...
setwd("C:/Users/ao7825/Documents/Maestria_MCDV2023/8_Labo2323/datasets")  #Establezco el Working Directory
